...
int halide_dotProduct(struct halide_buffer_t *_vectorA_buffer, struct halide_buffer_t *_vectorB_buffer, struct halide_buffer_t *_result_buffer) {
 ...
 uint64_t _0 = (uint64_t)(_vectorB_buffer);
 uint64_t _1 = (uint64_t)(0ull);
 bool _2 = _0 != _1;
 if (!_2)
 {
  int32_t _3 = halide_error_buffer_argument_is_null(_ucon, "vectorB");
  return _3;
 }
 uint64_t _4 = (uint64_t)(_vectorA_buffer);
 uint64_t _5 = (uint64_t)(0ull);
 bool _6 = _4 != _5;
 if (!_6)
 {
  int32_t _7 = halide_error_buffer_argument_is_null(_ucon, "vectorA");
  return _7;
 }
 uint64_t _8 = (uint64_t)(_result_buffer);
 uint64_t _9 = (uint64_t)(0ull);
 bool _10 = _8 != _9;
 if (!_10)
 {
  int32_t _11 = halide_error_buffer_argument_is_null(_ucon, "result");
  return _11;
 }
 auto *_12 = _halide_buffer_get_host(_result_buffer);
 auto _result = _12;
 halide_maybe_unused(_result);
 uint32_t _13 = _halide_buffer_get_type(_result_buffer);
 bool _14 = _halide_buffer_get_device_dirty(_result_buffer);
 int32_t _15 = _halide_buffer_get_dimensions(_result_buffer);
 int32_t _16 = _halide_buffer_get_min(_result_buffer, 0);
 int32_t _17 = _halide_buffer_get_extent(_result_buffer, 0);
 int32_t _18 = _halide_buffer_get_stride(_result_buffer, 0);
 auto *_19 = _halide_buffer_get_host(_vectorA_buffer);
 auto _vectorA = _19;
 halide_maybe_unused(_vectorA);
 uint32_t _20 = _halide_buffer_get_type(_vectorA_buffer);
 bool _21 = _halide_buffer_get_device_dirty(_vectorA_buffer);
 int32_t _22 = _halide_buffer_get_dimensions(_vectorA_buffer);
 int32_t _23 = _halide_buffer_get_min(_vectorA_buffer, 0);
 int32_t _24 = _halide_buffer_get_extent(_vectorA_buffer, 0);
 int32_t _25 = _halide_buffer_get_stride(_vectorA_buffer, 0);
 auto *_26 = _halide_buffer_get_host(_vectorB_buffer);
 auto _vectorB = _26;
 halide_maybe_unused(_vectorB);
 uint32_t _27 = _halide_buffer_get_type(_vectorB_buffer);
 bool _28 = _halide_buffer_get_device_dirty(_vectorB_buffer);
 int32_t _29 = _halide_buffer_get_dimensions(_vectorB_buffer);
 int32_t _30 = _halide_buffer_get_min(_vectorB_buffer, 0);
 int32_t _31 = _halide_buffer_get_extent(_vectorB_buffer, 0);
 int32_t _32 = _halide_buffer_get_stride(_vectorB_buffer, 0);
 bool _33 = _halide_buffer_is_bounds_query(_result_buffer);
 if (_33)
 {
  auto *_34 = _halide_buffer_get_shape(_result_buffer);
  ...
  auto *_38 = s0;
  auto *_39 = _halide_buffer_init(_result_buffer, _34, _35, _36, _37, 2, 32, 1, _38, _36);
  halide_maybe_unused(_39);
 } // if _33
 bool _40 = _halide_buffer_is_bounds_query(_vectorA_buffer);
 if (_40)
 {
  auto *_41 = _halide_buffer_get_shape(_vectorA_buffer);
  ...
  auto *_45 = s1;
  auto *_46 = _halide_buffer_init(_vectorA_buffer, _41, _42, _43, _44, 2, 32, 1, _45, _43);
  halide_maybe_unused(_46);
 } // if _40
 bool _47 = _halide_buffer_is_bounds_query(_vectorB_buffer);
 if (_47)
 {
  auto *_48 = _halide_buffer_get_shape(_vectorB_buffer);
  ...
  auto *_52 = s2;
  auto *_53 = _halide_buffer_init(_vectorB_buffer, _48, _49, _50, _51, 2, 32, 1, _52, _50);
  halide_maybe_unused(_53);
 } // if _47
 bool _54 = _halide_buffer_is_bounds_query(_vectorB_buffer);
 bool _55 = _halide_buffer_is_bounds_query(_result_buffer);
 bool _56 = _halide_buffer_is_bounds_query(_vectorA_buffer);
 bool _57 = _55 || _56;
 bool _58 = _54 || _57;
 bool _59 = !(_58);
 if (_59)
 {
  ...
  if (!_61)
  {
   ...
   int32_t _63 = halide_error_bad_type(_ucon, "Output buffer result", _13, _62);
   return _63;
  }
  bool _64 = _15 == 1;
  if (!_64)
  {
   int32_t _65 = halide_error_bad_dimensions(_ucon, "Output buffer result", _15, 1);
   return _65;
  }
  ...
  if (!_67)
  {
   ...
   int32_t _69 = halide_error_bad_type(_ucon, "Input buffer vectorA", _20, _68);
   return _69;
  }
  bool _70 = _22 == 1;
  if (!_70)
  {
   int32_t _71 = halide_error_bad_dimensions(_ucon, "Input buffer vectorA", _22, 1);
   return _71;
  }
  ...
  if (!_73)
  {
   ...
   int32_t _75 = halide_error_bad_type(_ucon, "Input buffer vectorB", _27, _74);
   return _75;
  }
  bool _76 = _29 == 1;
  if (!_76)
  {
   int32_t _77 = halide_error_bad_dimensions(_ucon, "Input buffer vectorB", _29, 1);
   return _77;
  }
  bool _78 = _16 <= 0;
  int32_t _79 = _17 + _16;
  ...
  if (!_81)
  {
   int32_t _82 = _17 + _16;
   int32_t _83 = _82 + -1;
   int32_t _84 = halide_error_access_out_of_bounds(_ucon, "Output buffer result", 0, 0, 0, _16, _83);
   return _84;
  }
  bool _85 = 0 <= _17;
  if (!_85)
  {
   int32_t _86 = halide_error_buffer_extents_negative(_ucon, "Output buffer result", 0, _17);
   return _86;
  }
  bool _87 = 0 <= _24;
  if (!_87)
  {
   int32_t _88 = halide_error_buffer_extents_negative(_ucon, "Input buffer vectorA", 0, _24);
   return _88;
  }
  bool _89 = _30 <= _23;
  int32_t _90 = _24 + _23;
  ...
  if (!_93)
  {
   ...
   int32_t _96 = _31 + _30;
   int32_t _97 = _96 + -1;
   int32_t _98 = halide_error_access_out_of_bounds(_ucon, "Input buffer vectorB", 0, _23, _95, _30, _97);
   return _98;
  }
  bool _99 = 0 <= _31;
  if (!_99)
  {
   int32_t _100 = halide_error_buffer_extents_negative(_ucon, "Input buffer vectorB", 0, _31);
   return _100;
  }
  bool _101 = _18 == 1;
  if (!_101)
  {
   int32_t _102 = halide_error_constraint_violated(_ucon, "result.stride.0", _18, "1", 1);
   return _102;
  }
  bool _103 = _25 == 1;
  if (!_103)
  {
   int32_t _104 = halide_error_constraint_violated(_ucon, "vectorA.stride.0", _25, "1", 1);
   return _104;
  }
  bool _105 = _32 == 1;
  if (!_105)
  {
   int32_t _106 = halide_error_constraint_violated(_ucon, "vectorB.stride.0", _32, "1", 1);
   return _106;
  }
  uint64_t _107 = (uint64_t)(_17);
  uint64_t _108 = (uint64_t)(2147483647ull);
  bool _109 = _107 <= _108;
  if (!_109)
  {
   uint64_t _110 = (uint64_t)(_17);
   uint64_t _111 = (uint64_t)(2147483647ull);
   int32_t _112 = halide_error_buffer_allocation_too_large(_ucon, "result", _110, _111);
   return _112;
  }
  uint64_t _113 = (uint64_t)(_24);
  uint64_t _114 = (uint64_t)(2147483647ull);
  bool _115 = _113 <= _114;
  if (!_115)
  {
   uint64_t _116 = (uint64_t)(_24);
   uint64_t _117 = (uint64_t)(2147483647ull);
   int32_t _118 = halide_error_buffer_allocation_too_large(_ucon, "vectorA", _116, _117);
   return _118;
  }
  uint64_t _119 = (uint64_t)(_31);
  uint64_t _120 = (uint64_t)(2147483647ull);
  bool _121 = _119 <= _120;
  if (!_121)
  {
   uint64_t _122 = (uint64_t)(_31);
   uint64_t _123 = (uint64_t)(2147483647ull);
   int32_t _124 = halide_error_buffer_allocation_too_large(_ucon, "vectorB", _122, _123);
   return _124;
  }
  bool _125 = !(_14);
  if (!_125)
  {
   int32_t _126 = halide_error_device_dirty_with_no_device_support(_ucon, "Output buffer result");
   return _126;
  }
  bool _127 = !(_21);
  if (!_127)
  {
   int32_t _128 = halide_error_device_dirty_with_no_device_support(_ucon, "Input buffer vectorA");
   return _128;
  }
  bool _129 = !(_28);
  if (!_129)
  {
   int32_t _130 = halide_error_device_dirty_with_no_device_support(_ucon, "Input buffer vectorB");
   return _130;
  }
  auto *_131 = (void *)(nullptr);
  bool _132 = _result != _131;
  if (!_132)
  {
   int32_t _133 = halide_error_host_is_null(_ucon, "Output buffer result");
   return _133;
  }
  auto *_134 = (void *)(nullptr);
  bool _135 = _vectorA != _134;
  if (!_135)
  {
   int32_t _136 = halide_error_host_is_null(_ucon, "Input buffer vectorA");
   return _136;
  }
  auto *_137 = (void *)(nullptr);
  bool _138 = _vectorB != _137;
  if (!_138)
  {
   int32_t _139 = halide_error_host_is_null(_ucon, "Input buffer vectorB");
   return _139;
  }
  bool _140 = 0 <= _16;
  int32_t _141 = _17 + _16;
  bool _142 = _141 <= 1;
  bool _143 = _140 && _142;
  if (!_143)
  {
   int32_t _144 = _17 + _16;
   int32_t _145 = _144 + -1;
   int32_t _146 = halide_error_explicit_bounds_too_small(_ucon, "v0", "result", 0, 0, _16, _145);
   return _146;
  }
  {
   float _sum[1]; // the results basically
   // produce result
   // produce sum
   float _147 = float_from_bits(0 /* 0 */); // as zero in binary
   _sum[0] = _147; // initialize the sum as 0
   int32_t _148 = _23 - _30; // get the offset for vectorB by subtracting the min index of vectorA from the min index of vectorB
   for (int _sum_s1_r6__x_rebased = 0; _sum_s1_r6__x_rebased < 0 + _24; _sum_s1_r6__x_rebased++) // for loop to iterate over the elements of vectorA and vectorB
   {
    float _149 = _sum[0];
    float _150 = ((float *)_vectorA)[_sum_s1_r6__x_rebased];
    int32_t _151 = _sum_s1_r6__x_rebased + _148;
    float _152 = ((float *)_vectorB)[_151];
    float _153 = _150 * _152;
    float _154 = _149 + _153;
    _sum[0] = _154;
   } // for _sum_s1_r6__x_rebased
   // consume sum
   float _155 = _sum[0];
   ((float *)_result)[0] = _155;
  } // alloc _sum
 } // if _59
 return 0;
}
...
const struct halide_filter_metadata_t *halide_dotProduct_metadata() {
 int64_t const *const *buffer_estimates__vectorA = nullptr;
 const halide_scalar_value_t *scalar_def__vectorA = nullptr;
 const halide_scalar_value_t *scalar_min__vectorA = nullptr;
 const halide_scalar_value_t *scalar_max__vectorA = nullptr;
 const halide_scalar_value_t *scalar_estimate__vectorA = nullptr;
 int64_t const *const *buffer_estimates__vectorB = nullptr;
 const halide_scalar_value_t *scalar_def__vectorB = nullptr;
 const halide_scalar_value_t *scalar_min__vectorB = nullptr;
 const halide_scalar_value_t *scalar_max__vectorB = nullptr;
 const halide_scalar_value_t *scalar_estimate__vectorB = nullptr;
 static const int64_t const_0 = 0LL;
 static const int64_t const_1 = 1LL;
 static const int64_t * const buffer_estimates__result[2] = {
  &const_0,
  &const_1,
 };
 const halide_scalar_value_t *scalar_def__result = nullptr;
 const halide_scalar_value_t *scalar_min__result = nullptr;
 const halide_scalar_value_t *scalar_max__result = nullptr;
 const halide_scalar_value_t *scalar_estimate__result = nullptr;
 static const halide_filter_argument_t args[3] = {
  {
   ...
   scalar_min__vectorA,
   scalar_max__vectorA,
   scalar_estimate__vectorA,
   buffer_estimates__vectorA,
   },
  {
   "vectorB",
   halide_argument_kind_input_buffer,
   ...
   scalar_min__vectorB,
   scalar_max__vectorB,
   scalar_estimate__vectorB,
   buffer_estimates__vectorB,
   },
  {
   "result",
   ...
   scalar_min__result,
   scalar_max__result,
   scalar_estimate__result,
   buffer_estimates__result,
   },
  };
 static const halide_filter_metadata_t md = {
  ...
  3,
  args,
  "x86-64-osx-avx-avx2-f16c-fma-sse41",
  "halide_dotProduct",
  };
 return &md;
}
