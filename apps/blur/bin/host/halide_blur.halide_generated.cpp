...
int halide_blur(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_blur_y_buffer) {
 ...
 uint64_t _0 = (uint64_t)(_input_buffer);
 uint64_t _1 = (uint64_t)(0ull);
 bool _2 = _0 != _1;
 if (!_2)
 {
  int32_t _3 = halide_error_buffer_argument_is_null(_ucon, "input");
  return _3;
 }
 uint64_t _4 = (uint64_t)(_blur_y_buffer);
 uint64_t _5 = (uint64_t)(0ull);
 bool _6 = _4 != _5;
 if (!_6)
 {
  int32_t _7 = halide_error_buffer_argument_is_null(_ucon, "blur_y");
  return _7;
 }
 auto *_8 = _halide_buffer_get_host(_blur_y_buffer);
 auto _blur_y = _8;
 halide_unused(_blur_y);
 uint32_t _9 = _halide_buffer_get_type(_blur_y_buffer);
 bool _10 = _halide_buffer_get_device_dirty(_blur_y_buffer);
 int32_t _11 = _halide_buffer_get_dimensions(_blur_y_buffer);
 int32_t _12 = _halide_buffer_get_min(_blur_y_buffer, 0);
 int32_t _13 = _halide_buffer_get_extent(_blur_y_buffer, 0);
 int32_t _14 = _halide_buffer_get_stride(_blur_y_buffer, 0);
 int32_t _15 = _halide_buffer_get_min(_blur_y_buffer, 1);
 int32_t _16 = _halide_buffer_get_extent(_blur_y_buffer, 1);
 int32_t _17 = _halide_buffer_get_stride(_blur_y_buffer, 1);
 auto *_18 = _halide_buffer_get_host(_input_buffer);
 auto _input = _18;
 halide_unused(_input);
 uint32_t _19 = _halide_buffer_get_type(_input_buffer);
 bool _20 = _halide_buffer_get_device_dirty(_input_buffer);
 int32_t _21 = _halide_buffer_get_dimensions(_input_buffer);
 int32_t _22 = _halide_buffer_get_min(_input_buffer, 0);
 int32_t _23 = _halide_buffer_get_extent(_input_buffer, 0);
 int32_t _24 = _halide_buffer_get_stride(_input_buffer, 0);
 int32_t _25 = _halide_buffer_get_min(_input_buffer, 1);
 int32_t _26 = _halide_buffer_get_extent(_input_buffer, 1);
 int32_t _27 = _halide_buffer_get_stride(_input_buffer, 1);
 bool _28 = _halide_buffer_is_bounds_query(_blur_y_buffer);
 if (_28)
 {
  auto *_29 = _halide_buffer_get_shape(_blur_y_buffer);
  uint64_t _30 = (uint64_t)(0ull);
  auto *_31 = (void *)(_30);
  auto *_32 = (struct halide_device_interface_t *)(_30);
  struct halide_dimension_t s0[2] = {
   {_12, _13, 1, 0},
   {_15, _16, _13, 0},
  };
  auto *_33 = s0;
  auto *_34 = _halide_buffer_init(_blur_y_buffer, _29, _31, _30, _32, 1, 16, 2, _33, _30);
  halide_unused(_34);
 } // if _28
 bool _35 = _halide_buffer_is_bounds_query(_input_buffer);
 if (_35)
 {
  auto *_36 = _halide_buffer_get_shape(_input_buffer);
  uint64_t _37 = (uint64_t)(0ull);
  auto *_38 = (void *)(_37);
  auto *_39 = (struct halide_device_interface_t *)(_37);
  int32_t _40 = _13 + 1;
  ...
  auto *_41 = s1;
  auto *_42 = _halide_buffer_init(_input_buffer, _36, _38, _37, _39, 1, 16, 2, _41, _37);
  halide_unused(_42);
 } // if _35
 bool _43 = _halide_buffer_is_bounds_query(_blur_y_buffer);
 bool _44 = _halide_buffer_is_bounds_query(_input_buffer);
 bool _45 = _43 || _44;
 bool _46 = !(_45);
 if (_46)
 {
  uint32_t _47 = (uint32_t)(69633ull);
  bool _48 = _9 == _47;
  if (!_48)
  {
   uint32_t _49 = (uint32_t)(69633ull);
   int32_t _50 = halide_error_bad_type(_ucon, "Output buffer blur_y", _9, _49);
   return _50;
  }
  bool _51 = _11 == 2;
  if (!_51)
  {
   int32_t _52 = halide_error_bad_dimensions(_ucon, "Output buffer blur_y", _11, 2);
   return _52;
  }
  uint32_t _53 = (uint32_t)(69633ull);
  bool _54 = _19 == _53;
  if (!_54)
  {
   uint32_t _55 = (uint32_t)(69633ull);
   int32_t _56 = halide_error_bad_type(_ucon, "Input buffer input", _19, _55);
   return _56;
  }
  bool _57 = _21 == 2;
  if (!_57)
  {
   int32_t _58 = halide_error_bad_dimensions(_ucon, "Input buffer input", _21, 2);
   return _58;
  }
  bool _59 = 0 <= _13;
  if (!_59)
  {
   int32_t _60 = halide_error_buffer_extents_negative(_ucon, "Output buffer blur_y", 0, _13);
   return _60;
  }
  bool _61 = 0 <= _16;
  if (!_61)
  {
   int32_t _62 = halide_error_buffer_extents_negative(_ucon, "Output buffer blur_y", 1, _16);
   return _62;
  }
  bool _63 = _22 <= _12;
  int32_t _64 = _13 + _12;
  ...
  if (!_68)
  {
   ...
   int32_t _70 = _23 + _22;
   int32_t _71 = _70 + -1;
   int32_t _72 = halide_error_access_out_of_bounds(_ucon, "Input buffer input", 0, _12, _69, _22, _71);
   return _72;
  }
  bool _73 = 0 <= _23;
  if (!_73)
  {
   int32_t _74 = halide_error_buffer_extents_negative(_ucon, "Input buffer input", 0, _23);
   return _74;
  }
  bool _75 = _25 <= _15;
  int32_t _76 = _16 + _15;
  ...
  if (!_79)
  {
   ...
   int32_t _82 = _26 + _25;
   int32_t _83 = _82 + -1;
   int32_t _84 = halide_error_access_out_of_bounds(_ucon, "Input buffer input", 1, _15, _81, _25, _83);
   return _84;
  }
  bool _85 = 0 <= _26;
  if (!_85)
  {
   int32_t _86 = halide_error_buffer_extents_negative(_ucon, "Input buffer input", 1, _26);
   return _86;
  }
  bool _87 = _14 == 1;
  if (!_87)
  {
   int32_t _88 = halide_error_constraint_violated(_ucon, "blur_y.stride.0", _14, "1", 1);
   return _88;
  }
  bool _89 = _24 == 1;
  if (!_89)
  {
   int32_t _90 = halide_error_constraint_violated(_ucon, "input.stride.0", _24, "1", 1);
   return _90;
  }
  int64_t _91 = (int64_t)(_16);
  int64_t _92 = (int64_t)(_13);
  int64_t _93 = _91 * _92;
  int64_t _94 = (int64_t)(_26);
  int64_t _95 = (int64_t)(_23);
  int64_t _96 = _94 * _95;
  uint64_t _97 = (uint64_t)(_13);
  uint64_t _98 = (uint64_t)(2147483647ull);
  bool _99 = _97 <= _98;
  if (!_99)
  {
   uint64_t _100 = (uint64_t)(_13);
   uint64_t _101 = (uint64_t)(2147483647ull);
   int32_t _102 = halide_error_buffer_allocation_too_large(_ucon, "blur_y", _100, _101);
   return _102;
  }
  int64_t _103 = (int64_t)(_16);
  int64_t _104 = (int64_t)(_17);
  int64_t _105 = _103 * _104;
  int64_t _106 = (int64_t)(0ll);
  int64_t _107 = _106 - _105;
  bool _108 = _105 > _106;
  int64_t _109 = (int64_t)(_108 ? _105 : _107);
  uint64_t _110 = (uint64_t)(_109);
  uint64_t _111 = _110;
  uint64_t _112 = (uint64_t)(2147483647ull);
  bool _113 = _111 <= _112;
  if (!_113)
  {
   int64_t _114 = (int64_t)(_16);
   int64_t _115 = (int64_t)(_17);
   int64_t _116 = _114 * _115;
   int64_t _117 = (int64_t)(0ll);
   ...
   int32_t _124 = halide_error_buffer_allocation_too_large(_ucon, "blur_y", _122, _123);
   return _124;
  }
  int64_t _125 = (int64_t)(2147483647ll);
  bool _126 = _93 <= _125;
  if (!_126)
  {
   int64_t _127 = (int64_t)(2147483647ll);
   int32_t _128 = halide_error_buffer_extents_too_large(_ucon, "blur_y", _93, _127);
   return _128;
  }
  uint64_t _129 = (uint64_t)(_23);
  uint64_t _130 = (uint64_t)(2147483647ull);
  bool _131 = _129 <= _130;
  if (!_131)
  {
   uint64_t _132 = (uint64_t)(_23);
   uint64_t _133 = (uint64_t)(2147483647ull);
   int32_t _134 = halide_error_buffer_allocation_too_large(_ucon, "input", _132, _133);
   return _134;
  }
  int64_t _135 = (int64_t)(_26);
  int64_t _136 = (int64_t)(_27);
  ...
  if (!_145)
  {
   int64_t _146 = (int64_t)(_26);
   int64_t _147 = (int64_t)(_27);
   int64_t _148 = _146 * _147;
   int64_t _149 = (int64_t)(0ll);
   int64_t _150 = _149 - _148;
   bool _151 = _148 > _149;
   int64_t _152 = (int64_t)(_151 ? _148 : _150);
   uint64_t _153 = (uint64_t)(_152);
   uint64_t _154 = _153;
   uint64_t _155 = (uint64_t)(2147483647ull);
   int32_t _156 = halide_error_buffer_allocation_too_large(_ucon, "input", _154, _155);
   return _156;
  }
  int64_t _157 = (int64_t)(2147483647ll);
  bool _158 = _96 <= _157;
  if (!_158)
  {
   int64_t _159 = (int64_t)(2147483647ll);
   int32_t _160 = halide_error_buffer_extents_too_large(_ucon, "input", _96, _159);
   return _160;
  }
  bool _161 = !(_10);
  if (!_161)
  {
   int32_t _162 = halide_error_device_dirty_with_no_device_support(_ucon, "Output buffer blur_y");
   return _162;
  }
  bool _163 = !(_20);
  if (!_163)
  {
   int32_t _164 = halide_error_device_dirty_with_no_device_support(_ucon, "Input buffer input");
   return _164;
  }
  uint64_t _165 = (uint64_t)(0ull);
  auto *_166 = (void *)(_165);
  bool _167 = _blur_y != _166;
  if (!_167)
  {
   int32_t _168 = halide_error_host_is_null(_ucon, "Output buffer blur_y");
   return _168;
  }
  uint64_t _169 = (uint64_t)(0ull);
  auto *_170 = (void *)(_169);
  bool _171 = _input != _170;
  if (!_171)
  {
   int32_t _172 = halide_error_host_is_null(_ucon, "Input buffer input");
   return _172;
  }
  // produce blur_y
  int32_t _173 = _25 * _27;
  int32_t _174 = _12 - _173;
  int32_t _175 = _174 - _22;
  int32_t _176 = _15 * _17;
  int32_t _177 = 0 - _176;
  for (int _blur_y_s0_y_rebased = 0; _blur_y_s0_y_rebased < 0 + _16; _blur_y_s0_y_rebased++)
  {
   int32_t _178 = _15 + _blur_y_s0_y_rebased;
   int32_t _179 = _27 * _178;
   int32_t _180 = _179 + _175;
   int32_t _181 = _17 * _178;
   int32_t _182 = _181 + _177;
   for (int _blur_y_s0_x_rebased = 0; _blur_y_s0_x_rebased < 0 + _13; _blur_y_s0_x_rebased++)
   {
    int32_t _183 = _blur_y_s0_x_rebased + _180;
    uint16_t _184 = ((uint16_t *)_input)[_183];
    int32_t _185 = _183 + 1;
    uint16_t _186 = ((uint16_t *)_input)[_185];
    uint16_t _187 = _184 + _186;
    int32_t _188 = _blur_y_s0_x_rebased + _182;
    ((uint16_t *)_blur_y)[_188] = _187;
   } // for _blur_y_s0_x_rebased
  } // for _blur_y_s0_y_rebased
 } // if _46
 return 0;
}
