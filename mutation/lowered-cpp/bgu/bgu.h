#ifndef HALIDE____home___ardi___project___dsl_mutants___halide___Halide___mutation___mutation___lowered___cpp___bgu___bgu_h
#define HALIDE____home___ardi___project___dsl_mutants___halide___Halide___mutation___mutation___lowered___cpp___bgu___bgu_h
#include <stdint.h>
...
int bgu(float _r_sigma, int32_t _s_sigma, struct halide_buffer_t *_splat_loc_buffer, struct halide_buffer_t *_values_buffer, struct halide_buffer_t *_slice_loc_buffer, struct halide_buffer_t *_slice_buffer);

HALIDE_FUNCTION_ATTRS
int bgu_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *bgu_metadata();
