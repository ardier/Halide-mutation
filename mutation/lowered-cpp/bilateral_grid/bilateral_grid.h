#ifndef HALIDE__mutation___lowered___cpp___bilateral_grid___bilateral_grid_h
#define HALIDE__mutation___lowered___cpp___bilateral_grid___bilateral_grid_h
#include <stdint.h>
...
int bilateral_grid(struct halide_buffer_t *_input_buffer, float _r_sigma, struct halide_buffer_t *_bilateral_grid_buffer);

HALIDE_FUNCTION_ATTRS
int bilateral_grid_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *bilateral_grid_metadata();
