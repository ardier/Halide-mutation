#ifndef HALIDE____mnt___scratch1___ardi___dsl_mut____priv___79c69961___gap___lower___repo___mutation___lowered___cpp___c_backend___pipeline_cpp_cpp_h
#define HALIDE____mnt___scratch1___ardi___dsl_mut____priv___79c69961___gap___lower___repo___mutation___lowered___cpp___c_backend___pipeline_cpp_cpp_h
#include <stdint.h>
...
int pipeline_cpp_cpp(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int pipeline_cpp_cpp_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *pipeline_cpp_cpp_metadata();
