#ifndef HALIDE__mutation___lowered___cpp___camera_pipe___camera_pipe_h
#define HALIDE__mutation___lowered___cpp___camera_pipe___camera_pipe_h
#include <stdint.h>
...
int camera_pipe(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_matrix_3200_buffer, struct halide_buffer_t *_matrix_7000_buffer, float _color_temp, float _gamma, float _contrast, float _sharpen_strength, int32_t _blackLevel, int32_t _whiteLevel, struct halide_buffer_t *_processed_buffer);

HALIDE_FUNCTION_ATTRS
int camera_pipe_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *camera_pipe_metadata();
