#ifndef HALIDE____home___ardi___project___dsl_mutants___halide___Halide___mutation___mutation___lowered___cpp___conv_layer___conv_layer_h
#define HALIDE____home___ardi___project___dsl_mutants___halide___Halide___mutation___mutation___lowered___cpp___conv_layer___conv_layer_h
#include <stdint.h>
...
int conv_layer(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_filter_buffer, struct halide_buffer_t *_bias_buffer, struct halide_buffer_t *_relu_buffer);

HALIDE_FUNCTION_ATTRS
int conv_layer_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *conv_layer_metadata();
