#ifndef HALIDE____home___ardi___project___dsl_mutants___halide___Halide___mutation___mutation___lowered___cpp___depthwise_separable_conv___depthwise_separable_conv_h
#define HALIDE____home___ardi___project___dsl_mutants___halide___Halide___mutation___mutation___lowered___cpp___depthwise_separable_conv___depthwise_separable_conv_h
#include <stdint.h>
...
int depthwise_separable_conv(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_depthwise_filter_buffer, struct halide_buffer_t *_pointwise_filter_buffer, struct halide_buffer_t *_bias_buffer, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int depthwise_separable_conv_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *depthwise_separable_conv_metadata();
