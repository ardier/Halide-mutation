#ifndef HALIDE____mnt___scratch1___ardi___dsl_mut____priv___79c69961___gap___lower___repo___mutation___lowered___cpp___fft___fft_forward_r2c_h
#define HALIDE____mnt___scratch1___ardi___dsl_mut____priv___79c69961___gap___lower___repo___mutation___lowered___cpp___fft___fft_forward_r2c_h
#include <stdint.h>
...
int fft_forward_r2c(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int fft_forward_r2c_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *fft_forward_r2c_metadata();
