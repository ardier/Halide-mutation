#ifndef HALIDE__mutation___lowered___cpp___harris___harris_h
#define HALIDE__mutation___lowered___cpp___harris___harris_h
#include <stdint.h>
...
int harris(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int harris_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *harris_metadata();
