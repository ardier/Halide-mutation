#ifndef HALIDE____home___ardi___project___dsl_mutants___halide___Halide___mutation___mutation___lowered___cpp___hist___hist_h
#define HALIDE____home___ardi___project___dsl_mutants___halide___Halide___mutation___mutation___lowered___cpp___hist___hist_h
#include <stdint.h>
...
int hist(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int hist_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *hist_metadata();
