#ifndef HALIDE____home___ardi___project___dsl_mutants___halide___Halide___mutation___mutation___lowered___cpp___lens_blur___lens_blur_h
#define HALIDE____home___ardi___project___dsl_mutants___halide___Halide___mutation___mutation___lowered___cpp___lens_blur___lens_blur_h
#include <stdint.h>
...
int lens_blur(struct halide_buffer_t *_left_im_buffer, struct halide_buffer_t *_right_im_buffer, int32_t _slices, int32_t _focus_depth, float _blur_radius_scale, int32_t _aperture_samples, struct halide_buffer_t *_final_buffer);

HALIDE_FUNCTION_ATTRS
int lens_blur_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *lens_blur_metadata();
