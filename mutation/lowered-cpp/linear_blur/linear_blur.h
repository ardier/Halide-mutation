#ifndef HALIDE____mnt___scratch1___ardi___dsl_mut____priv___79c69961___gap___lower2___repo___mutation___lowered___cpp___linear_blur___linear_blur_h
#define HALIDE____mnt___scratch1___ardi___dsl_mut____priv___79c69961___gap___lower2___repo___mutation___lowered___cpp___linear_blur___linear_blur_h
#include <stdint.h>
...
int linear_blur(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int linear_blur_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *linear_blur_metadata();
