#ifndef HALIDE____mnt___scratch1___ardi___dsl_mut____priv___79c69961___gap___lower___repo___mutation___lowered___cpp___linear_blur___linear_to_srgb_h
#define HALIDE____mnt___scratch1___ardi___dsl_mut____priv___79c69961___gap___lower___repo___mutation___lowered___cpp___linear_blur___linear_to_srgb_h
#include <stdint.h>
...
int linear_to_srgb(struct halide_buffer_t *_linear_buffer, struct halide_buffer_t *_srgb_buffer);

HALIDE_FUNCTION_ATTRS
int linear_to_srgb_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *linear_to_srgb_metadata();
