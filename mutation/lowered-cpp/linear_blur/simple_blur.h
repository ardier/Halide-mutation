#ifndef HALIDE____mnt___scratch1___ardi___dsl_mut____priv___79c69961___gap___lower___repo___mutation___lowered___cpp___linear_blur___simple_blur_h
#define HALIDE____mnt___scratch1___ardi___dsl_mut____priv___79c69961___gap___lower___repo___mutation___lowered___cpp___linear_blur___simple_blur_h
#include <stdint.h>
...
int simple_blur(struct halide_buffer_t *_input_buffer, int32_t _width, int32_t _height, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int simple_blur_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *simple_blur_metadata();
