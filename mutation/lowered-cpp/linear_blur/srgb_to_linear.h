#ifndef HALIDE____mnt___scratch1___ardi___dsl_mut____priv___79c69961___gap___lower___repo___mutation___lowered___cpp___linear_blur___srgb_to_linear_h
#define HALIDE____mnt___scratch1___ardi___dsl_mut____priv___79c69961___gap___lower___repo___mutation___lowered___cpp___linear_blur___srgb_to_linear_h
#include <stdint.h>
...
int srgb_to_linear(struct halide_buffer_t *_srgb_buffer, struct halide_buffer_t *_linear_buffer);

HALIDE_FUNCTION_ATTRS
int srgb_to_linear_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *srgb_to_linear_metadata();
