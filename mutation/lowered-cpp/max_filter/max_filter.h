#ifndef HALIDE____home___ardi___project___dsl_mutants___halide___Halide___mutation___mutation___lowered___cpp___max_filter___max_filter_h
#define HALIDE____home___ardi___project___dsl_mutants___halide___Halide___mutation___mutation___lowered___cpp___max_filter___max_filter_h
#include <stdint.h>
...
int max_filter(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int max_filter_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *max_filter_metadata();
