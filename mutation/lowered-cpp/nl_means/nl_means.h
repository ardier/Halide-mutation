#ifndef HALIDE____home___ardi___project___dsl_mutants___halide___Halide___mutation___mutation___lowered___cpp___nl_means___nl_means_h
#define HALIDE____home___ardi___project___dsl_mutants___halide___Halide___mutation___mutation___lowered___cpp___nl_means___nl_means_h
#include <stdint.h>
...
int nl_means(struct halide_buffer_t *_input_buffer, int32_t _patch_size, int32_t _search_area, float _sigma, struct halide_buffer_t *_non_local_means_buffer);

HALIDE_FUNCTION_ATTRS
int nl_means_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *nl_means_metadata();
