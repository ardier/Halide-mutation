#ifndef HALIDE____mnt___scratch1___ardi___dsl_mut____priv___79c69961___gap___lower___repo___mutation___lowered___cpp___resize___resize_linear_float32_up_h
#define HALIDE____mnt___scratch1___ardi___dsl_mut____priv___79c69961___gap___lower___repo___mutation___lowered___cpp___resize___resize_linear_float32_up_h
#include <stdint.h>
...
int resize_linear_float32_up(struct halide_buffer_t *_input_buffer, float _scale_factor, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int resize_linear_float32_up_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *resize_linear_float32_up_metadata();
