#ifndef HALIDE____mnt___scratch1___ardi___dsl_mut____priv___79c69961___gap___lower___repo___mutation___lowered___cpp___tut_lesson_15___my_first_generator_h
#define HALIDE____mnt___scratch1___ardi___dsl_mut____priv___79c69961___gap___lower___repo___mutation___lowered___cpp___tut_lesson_15___my_first_generator_h
#include <stdint.h>
...
int my_first_generator(uint8_t _offset, struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_brighter_buffer);

HALIDE_FUNCTION_ATTRS
int my_first_generator_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *my_first_generator_metadata();
