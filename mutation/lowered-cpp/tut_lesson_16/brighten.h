#ifndef HALIDE____mnt___scratch1___ardi___dsl_mut____priv___79c69961___gap___lower___repo___mutation___lowered___cpp___tut_lesson_16___brighten_h
#define HALIDE____mnt___scratch1___ardi___dsl_mut____priv___79c69961___gap___lower___repo___mutation___lowered___cpp___tut_lesson_16___brighten_h
#include <stdint.h>
...
int brighten(struct halide_buffer_t *_input_buffer, uint8_t _offset, struct halide_buffer_t *_brighter_buffer);

HALIDE_FUNCTION_ATTRS
int brighten_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *brighten_metadata();
