#ifndef HALIDE____mnt___scratch1___ardi___dsl_mut____priv___79c69961___gap___lower___repo___mutation___lowered___cpp___tut_lesson_21___auto_schedule_gen_h
#define HALIDE____mnt___scratch1___ardi___dsl_mut____priv___79c69961___gap___lower___repo___mutation___lowered___cpp___tut_lesson_21___auto_schedule_gen_h
#include <stdint.h>
...
int auto_schedule_gen(struct halide_buffer_t *_input_buffer, float _factor, struct halide_buffer_t *_output1_buffer, struct halide_buffer_t *_output2_buffer);

HALIDE_FUNCTION_ATTRS
int auto_schedule_gen_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *auto_schedule_gen_metadata();
