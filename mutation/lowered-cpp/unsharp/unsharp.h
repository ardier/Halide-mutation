#ifndef HALIDE__mutation___lowered___cpp___unsharp___unsharp_h
#define HALIDE__mutation___lowered___cpp___unsharp___unsharp_h
#include <stdint.h>
...
int unsharp(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int unsharp_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *unsharp_metadata();
