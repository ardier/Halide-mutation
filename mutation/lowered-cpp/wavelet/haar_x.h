#ifndef HALIDE____mnt___scratch1___ardi___dsl_mut____priv___79c69961___gap___lower___repo___mutation___lowered___cpp___wavelet___haar_x_h
#define HALIDE____mnt___scratch1___ardi___dsl_mut____priv___79c69961___gap___lower___repo___mutation___lowered___cpp___wavelet___haar_x_h
#include <stdint.h>
...
int haar_x(struct halide_buffer_t *_in_buffer, struct halide_buffer_t *_out_buffer);

HALIDE_FUNCTION_ATTRS
int haar_x_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *haar_x_metadata();
